...
export default function StatusBar() {
  ...
  return (
    <div style={{
      ...
      {/* Gold scan line */}
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '1px', background: 'linear-gradient(90deg, transparent, rgba(212,175,55,0.6), rgba(240,199,94,0.4), transparent)' }} />

      {/* Left: Online members + server status */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <div style={{ width: '7px', height: '7px', background: '#22c55e', borderRadius: '50%', boxShadow: '0 0 8px rgba(34,197,94,0.8)', animation: 'blink 2s infinite' }} />
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '9px', color: '#5a5a6a', letterSpacing: '0.12em' }}>ONLINE</span>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '10px', color: '#f0c75e', fontWeight: '700' }}>{online.toLocaleString()}</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '9px', color: '#5a5a6a', letterSpacing: '0.12em' }}>SERVER</span>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '10px', color: '#22c55e', fontWeight: '700' }}>ONLINE</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#f0c75e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2a10 10 0 100 20 10 10 0 000-20z M12 6v6l4 2" />
          </svg>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '9px', color: '#5a5a6a', letterSpacing: '0.12em' }}>PING</span>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '10px', color: '#f0c75e', fontWeight: '700' }}>{ping}ms</span>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          {SOCIALS.map((social) => (
            <a key={social.name} href="#" style={{ color: '#5a5a6a', transition: 'color 0.2s', display: 'flex' }}>
        ...
        {/* Divider */}
        <div style={{ width: '1px', height: '20px', background: 'rgba(212,175,55,0.2)' }} />

        {/* Clock */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '9px', color: '#a07d20', letterSpacing: '0.1em' }}>{dateStr.toUpperCase()}</span>
          <span style={{ fontFamily: 'Orbitron,monospace', fontSize: '12px', color: '#f0c75e', fontWeight: '700', textShadow: '0 0 8px rgba(212,175,55,0.5)' }}>{timeStr}</span>
        </div>
      </div>
    </div>
  );
